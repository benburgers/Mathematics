...
public static class FourierTransform
{
    ...
    /// <param name="e">The value of Euler's number "e".</param>
    /// <param name="pi">The value of π.</param>
        ...
        IRootFunctions<TComplexComponent>
    {
        ...
        var args =
            new DarbouxStepArgsSync<Complex<TComplexComponent>>(
                start,
                end,
                new Complex<TComplexComponent>(0.01d, TComplexComponent.Zero),
