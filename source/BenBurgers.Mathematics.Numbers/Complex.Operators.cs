...
{
    /// <inheritdoc />
    public static Complex<TComplexComponent> operator +(Complex<TComplexComponent> value)
    {
    ...
    /// <inheritdoc />
    public static bool operator ==(Complex<TComplexComponent> left, Complex<TComplexComponent> right) =>
        left.Equals(right);
